...
*/
	 ...
	 */
	for_each_cpu_and(cpu, nohz.idle_cpus_mask, cpu_active_mask) {
				    ...
				    int sd_flag, int wake_flags)
{
	 ...
	 * on inactive CPUs.
	 */
	if (unlikely(!cpumask_intersects(nohz.idle_cpus_mask, cpu_active_mask)))
		return cpumask_first(nohz.idle_cpus_mask);
